      ...
      <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
        <div className="w-full md:w-1/2">
          ...
          <div className="mb-10 md:mb-20 text-gray-600 font-light">
            <h1 className="font-black uppercase text-3xl lg:text-5xl text-[#EAB308] mb-10">
              You seem to be lost!
            </h1>
            <p className="text-lg">
          ...
          <div className="mb-20 md:mb-0">
            <Link to="/">
              <Button
                size="sm"
                color="amber"
                className="text-lg font-medium outline-none focus:outline-none transform transition-all hover:scale-110 text-indigo-500 hover:text-indigo-600"
              >
                Go Back
              </Button>
            </Link>
